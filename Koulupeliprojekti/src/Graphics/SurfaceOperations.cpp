...
void SetColor(int x, int y, SDL_Color color, SDL_Surface *surface)
{
  SetRed(x, y, color.r, surface);
  SetGreen(x, y, color.g, surface);
  SetBlue(x, y, color.g, surface);
  SetAlpha(x, y, color.a, surface);
}