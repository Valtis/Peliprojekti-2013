...
void MemoryManager::WriteToArrayIndex(const VMObject object, const void *value, 
...
void MemoryManager::ReadFromArrayIndex(const VMObject object, void *value, 
...
MemoryManager::ArrayReadWriteData MemoryManager::ArrayReadWriteCommon(const VMObject object, 
...
void MemoryManager::EnsureNotNull(VMObject object) const {
  if (object.as_managed_pointer() == VM_NULLPTR) {
    throw std::runtime_error("Null pointer");
  }
}

uint32_t MemoryManager::GetTypeField(VMObject object) const {
...
uint32_t MemoryManager::GetArrayLength(VMObject object) const {
...
uint32_t MemoryManager::GetArrayLengthUnchecked(VMObject object) const {
