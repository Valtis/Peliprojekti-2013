...
enum class MessageType : int { NONE, LOCATION_CHANGE, VELOCITY_CHANGE, SET_VELOCITY,  MOUSE_COMMAND, 
  CONTROL_COMMAND, COLLISION, SPAWN_ENTITY, TERMINATE_ENTITY, TAKE_DAMAGE, END_LEVEL, END_GAME, CREATE_NEW_TILED_SPRITE,
  START_BLINKING, SET_GRAPHICS_VISIBILITY, RESET_ENTITY_POSITION };
